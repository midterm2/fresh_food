...
SOURCEFILES_QUOTED_IF_SPACED=harwave/mydelay.c harwave/UART.c main_fresh.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/harwave/mydelay.o ${OBJECTDIR}/harwave/UART.o ${OBJECTDIR}/main_fresh.o
POSSIBLE_DEPFILES=${OBJECTDIR}/harwave/mydelay.o.d ${OBJECTDIR}/harwave/UART.o.d ${OBJECTDIR}/main_fresh.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/harwave/mydelay.o ${OBJECTDIR}/harwave/UART.o ${OBJECTDIR}/main_fresh.o

# Source Files
SOURCEFILES=harwave/mydelay.c harwave/UART.c main_fresh.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/harwave/mydelay.o: harwave/mydelay.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/harwave" 
	@${RM} ${OBJECTDIR}/harwave/mydelay.o.d 
	@${RM} ${OBJECTDIR}/harwave/mydelay.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  harwave/mydelay.c  -o ${OBJECTDIR}/harwave/mydelay.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/harwave/mydelay.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -I"harwave" -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/harwave/mydelay.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/harwave/mydelay.o: harwave/mydelay.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/harwave/mydelay.o.d 
	@${RM} ${OBJECTDIR}/harwave/mydelay.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  harwave/mydelay.c  -o ${OBJECTDIR}/harwave/mydelay.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/harwave/mydelay.o.d"        -g -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -I"harwave" -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/harwave/mydelay.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
